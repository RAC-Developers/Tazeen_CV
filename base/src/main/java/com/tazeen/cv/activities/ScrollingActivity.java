package com.tazeen.cv.activities;
...
import com.tazeen.cv.adapters.ViewPagerAdapter;
import com.tazeen.cv.base.R;
import com.tazeen.cv.fragments.AboutFragment;
import com.tazeen.cv.fragments.EducationFragment;
import com.tazeen.cv.fragments.ProfessionFragment;
...
public class ScrollingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView coverImage = findViewById(R.id.coverPhoto);
        ...
        Picasso.get().load(R.drawable.coverphoto).into(coverImage);
